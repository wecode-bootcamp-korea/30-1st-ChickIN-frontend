          ...
          <div className="cart_content_list">
            <div class="order_table">
              <table>
                <thead>
                  <tr>
                    <th className="th_product">상품 및 수량</th>
                    <th className="th_product_price">상품 금액</th>
                    <th className="th_total_price">합계 금액</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td className="td_product_total_price">
                      <p>100,500원</p>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="td_option_total_price">
                      <p>6,000원</p>
                    </td>
                  </tr>
                </tbody>
